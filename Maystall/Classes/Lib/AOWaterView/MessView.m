...
-(id)initWithData:(DataInfo *)data yPoint:(float) y{
    ...
    if (self) {
        ...
        UIView *baseView = [[UIView alloc] initWithFrame:CGRectMake(1, 2, WIDTH-2, sImgH + newSize.height+18)];
        ...
        [imageBtn setImageFromUrl:YES withUrl:data.image];//设置图片地质
        ...
        //价格文字
        UILabel *price = [[UILabel alloc] initWithFrame:CGRectMake(5, sImgH +newSize.height, 35, 20)];
        price.text = data.price;
        price.backgroundColor = [UIColor clearColor];
        price.textColor = [UIColor orangeColor];
        price.font = [UIFont fontWithName:@"Helvetica" size:9];
        //评论图标
        UIImageView *imageComment = [[UIImageView alloc] initWithFrame:CGRectMake(40, sImgH +newSize.height +4, 15, 15)];
        imageComment.image = [UIImage imageNamed:@"commont_icon"];
        //评论数量
        UILabel *comment = [[UILabel alloc] initWithFrame:CGRectMake(55, sImgH +newSize.height, 30, 20)];
        ...
        //收藏图标
        UIImageView *imagefav = [[UIImageView alloc] initWithFrame:CGRectMake(75, sImgH +newSize.height +3, 15, 15)];
        imagefav.image = [UIImage imageNamed:@"collect_count_icon"];
        //收藏数量
        UILabel *fav = [[UILabel alloc] initWithFrame:CGRectMake(90, sImgH +newSize.height, 30, 20)];
